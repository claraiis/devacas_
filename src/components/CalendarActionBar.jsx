...
import { RotateCcw, Share, SlidersHorizontal, Wand2 } from 'lucide-react';
...
const CalendarActionBar = ({
  ...
  return (
    <div className="fixed bottom-[calc(env(safe-area-inset-bottom)+1rem)] left-1/2 z-[90] -translate-x-1/2 pointer-events-auto">
